...
def doorframelines(result_df):
    ...
    if not ('doorframelines1' in subfeature_dict and 'doorframelines2' in subfeature_dict ):
        if ('doorframelines1' in subfeature_dict or 'doorframelines2' in subfeature_dict ):
...
def main():
    ...
    global feature_list, subfeature_dict, subfeature_valid_list, flightName, imageName ,image_file_path, no_of_tests
    
    global subfeature_dict_rel_dist_cluster , subfeature_dict_rel_dist
    
    global subfeature_dict_btw_dfl, subfeature_dict_r_dfl, subfeature_dict_l_dfl
    
    global subfeature_dict_abv_dfp,subfeature_dict_abv_dh ,subfeature_dict_final_ranking
